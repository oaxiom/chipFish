    ...
    def startup(self, genome="mm9", tracklist=None):
        ...
        **Arguments**
        ...
        if genome == "mm8":
            ...
            self.draw.bindTrack(track(filename="../Tracks/PEC_Untre.p1.trk", name="PEC -IL10 p1"), track_type="graph_split_strand")
            self.draw.bindTrack(track(filename="../Tracks/PEC_Untre.p2.trk", name="PEC -IL10 p2"), track_type="graph_split_strand")
            self.draw.bindTrack(track(filename="../Tracks/PEC_pIL10.p1.trk", name="PEC +IL10 p1"), track_type="graph_split_strand")
            self.draw.bindTrack(track(filename="../Tracks/PEC_pIL10.p2.trk", name="PEC +IL10 p2"), track_type="graph_split_strand")
