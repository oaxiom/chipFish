...
import learner.greedy, learner.custom, learner.simanneal, learner.exhaustive 
...
class bayes:
    ...
    def learn(self, mode="greedy", num_learners=1, max_iterations=10000):
        ...
        **Arguments**
        ...
        if mode == "greedy":
            self.learners = [learner.greedy.GreedyLearner(self.__dataset, max_iterations=max_iterations) for i in xrange(num_learners)]
        elif mode == "exhaustive": 
            self.learners = [learner.greedy.ListLearner(self.__dataset) for i in xrange(num_learners)]
