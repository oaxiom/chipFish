...
def bed_to_flat(infilename, outfilename, name, isPE, read_extend=None, gzip=None, **kargs):
    """
    **Purpose**
    ...
    **Arguments**
        ...
        isPE (Required)
            Does the BED contain PE fragments?
    ...
    **Returns**
    ...
    if not isPE:
        assert read_extend, 'You must specify a read_extend if isPE=False'
        raise AssertionError, 'isPE=False not supported!'
